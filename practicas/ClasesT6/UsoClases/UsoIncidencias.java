...
import practicas.ClasesT6.Clases.Incidencia;
import practicas.ClasesT6.Clases.Incidencia.estadoIndicencia;

public class UsoIncidencias {
    ...
    public static void main(String[] args) {
        ...
        inc1.setEstado(estadoIndicencia.EN_PROCESO);
